...
function getAllDirectors(movies) {
    // const arrayMovies2 = {... arrayMovies}
    movies.map((param) =>{return param.director}
);}


function howManyMovies(movies){
    movies.filter((param) =>{
        if (param.director === "Steven Spielberg" && param.director === "Drama")
    }
    
}
// {
// if (param.director === "Steven Spielberg" && param.director[param] === "Drama"){
//     return 
// }
// }
